...
This document describes how to maintain Playwright integration in Veyra.

## Overview

Veyra integrates Playwright's browser automation capabilities through patches and additional files. These need to be kept in sync with upstream Playwright development.
