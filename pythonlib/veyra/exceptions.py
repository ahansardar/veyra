class UnsupportedVersion(Exception):
    """
    Raised when the Veyra executable is outdated.
    """
...
class VeyraNotInstalled(FileNotFoundError):
    """
    Raised when veyra is not installed.
    """
...
class ProfileDirectoryError(RuntimeError):
    """Raised when Veyra's required runtime directory cannot be prepared."""
