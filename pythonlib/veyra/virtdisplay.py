...
from veyra.exceptions import (
    CannotExecuteXvfb,
    CannotFindXvfb,
    VirtualDisplayNotSupported,
)
from veyra.pkgman import OS_NAME
...
#
# 1x1x24 is Veyra's long-standing default and stays the default. The root
...
# (Veyra's long-standing default) and keep the escape hatch:
# VEYRA_VIRTUAL_DISPLAY_COMPOSITE=1 enables it.
COMPOSITE_ENV_VAR = "VEYRA_VIRTUAL_DISPLAY_COMPOSITE"
