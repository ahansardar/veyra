        ...
        Column {
            ...
            T {
                ...
                text: dlgAct === "promptInstall"
                    ? "Veyra " + dlgVer + "-" + dlgBuild + " is now active but not installed. Install it now?"
                    : dlgAct === "promptPin"
                    ? "Veyra " + dlgVer + "-" + dlgBuild + " is installed but not active. Would you like to pin this version?"
                    : dlgAct === "promptFollow"
                    ? "Veyra " + dlgVer + "-" + dlgBuild + " is installed but not active. Would you like to follow " + dlgChannel + " for updates?"
                    : (dlgAct === "install" ? "Install" : dlgAct === "uninstall" ? "Remove" : "Set") +
                      " Veyra " + dlgVer + "-" + dlgBuild +
