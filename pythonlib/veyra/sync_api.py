...
class Veyra(PlaywrightContextManager):
    """
    ...
    def __enter__(self) -> Union[Browser, BrowserContext]:
        ...
        try:
            ...
            # Veyra/Playwright start in this thread fails with "Sync API inside
    ...
    def __exit__(self, *args: Any):
        ...
        # "running" state, so every later sync Veyra/Playwright start in the same
...
def NewBrowser(
    ...
    **kwargs,
    ...
    """
    Launches a new browser instance for Veyra given a set of launch options.
...
def NewContext(
    ...
    **context_kwargs: Any,
    ...
    Parameters:
        browser: A Browser instance from NewBrowser or Veyra.
