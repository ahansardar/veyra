"""
Manager for handling multiple Veyra versions side by side
"""
...
class InstalledVersion:
    """
    Information about an installed Veyra version
    """
...
def install_versioned(fetcher, replace: bool = False) -> bool:
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile() as temp_file:
            ...
            rprint(f'Extracting Veyra: {install_path}')
        ...
        rprint(f'\nVeyra v{fetcher.verstr} installed.', fg="green")
...
def print_tree(show_header: bool = True, show_paths: bool = False) -> None:
    ...
    if not installed:
        ...
        rprint("Run `veyra fetch` to install.", fg="yellow")
        return
