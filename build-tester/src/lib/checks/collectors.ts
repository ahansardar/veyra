...
export async function collectFingerprints(): Promise<FingerprintData> {
  ...
  // resolution cache. On macOS Global (VEYRA_CONFIG), this causes "monospace" to resolve to
  // a different actual font between the two collectFingerprints() calls (42.6px delta observed).
  // Arial is a concrete font always available in all Veyra font lists, immune to this.
