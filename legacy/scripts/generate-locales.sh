...
if [ ! -f browser/locales/shipped-locales ]; then
  echo "ERROR: Run this script from the root of the Veyra source code"
  exit 1
fi
...
generate_locale() {
  ...
  mv browser/locales/l10n/$1/browser/branding/official browser/locales/l10n/$1/browser/branding/veyra
  find browser/locales/l10n/$1 -type f -exec sed -i -e 's/Mozilla Firefox/Veyra/g' {} \;
  find browser/locales/l10n/$1 -type f -exec sed -i -e 's/Mozilla/Veyra/g' {} \;
  find browser/locales/l10n/$1 -type f -exec sed -i -e 's/Firefox/Veyra/g' {} \;
  echo_status "Done"
  sleep 0.3
  echo_status
}
