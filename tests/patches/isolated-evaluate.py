...
This is Veyra's core automation-stealth property: Playwright routes
...
Run against a specific build:
    VEYRA_EXECUTABLE_PATH=/path/to/veyra-bin python tests/patches/isolated-evaluate.py
...
async def _run() -> bool:
    ...
    async with AsyncVeyra(**_launch_kwargs()) as browser:
