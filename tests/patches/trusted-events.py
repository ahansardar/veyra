...
Run against a specific build:
    VEYRA_EXECUTABLE_PATH=/path/to/veyra-bin python tests/patches/trusted-events.py
...
<script>
  ...
  document.addEventListener('veyra:publish', window.publish, true);
</script>
"""
...
class Recorder:
    ...
    async def drain(self) -> List[Dict[str, Any]]:
        ...
        await self._page.evaluate(
            "document.dispatchEvent(new Event('veyra:publish'))"
        )
...
async def main() -> int:
    ...
    async with AsyncVeyra(**kwargs) as browser:
