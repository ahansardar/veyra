...
Run from dvsa-bot to get the right venv:
    ...
    uv run python ~/20tech/oss/veyra/tests/patches/2026-04-30-system-ui-font-override.py
...
from helpers import launch_veyra
...
async def test_os(target_os: str) -> bool:
    ...
    async with launch_veyra(os=target_os) as (page, config):
